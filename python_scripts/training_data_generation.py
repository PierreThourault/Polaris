...
def define_dataset_params(num_examples, sys_params,
    ...
    # So beamspot_order_max = 6.0 gives SG ∈ [1, 6] ✓
...
def define_scan_parameters(dataset_params):
    ...
    dataset_params["beamspot_order_default"] = 5.0 #3.6 xavier ico80 60+20
    dataset_params["beamspot_radius_default"] = dataset_params['target_radius']*0.75
...
def main(argv):
    ...
    try:
        ...
        if '=' in argv[2]:
            ...
            run_type = str(argv[2])
        num_examples = 1  # default value
        args_start = 3

    # Parse optional TO/BM/perturbation arguments
    num_perturbations = None # number of perturbation samples (if None, uses default in define_dataset_params)
    ...
    pi_amplitude = None # power imbalance amplitude (fraction of default power ?)
